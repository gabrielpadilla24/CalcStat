...
import QuantCalculator from "./pages/Quant/QuantCalculator";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route
          path="/probabilityandstats/geometricdistribution"
          element={<GeometricCalculator />}
        />
        ...
        <Route path="/quant" element={<QuantCalculator />} />
