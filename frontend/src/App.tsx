...
import IntegralsCalculator from "./pages/CalculusCalculator/IntegralCalculus/Integrals/IntegralsCalculator";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Integral Calculus */}
        <Route path="/calculus/integrals" element={<IntegralsCalculator />} />
