    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-4 pb-20">
        ...
        <div className="bg-white rounded-md shadow-md p-6 border border-[#e0e0e0] flex flex-col justify-between text-left">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Explore the expected value, variance, and moments of a distribution.
          </p>
          <Link to="/probabilityandstats/expectedvalueandmoments">
            <SubmitButton text="Open Calculator" />
          </Link>
        </div>
        ...
        <div className="bg-white rounded-md shadow-md p-6 border border-[#e0e0e0] flex flex-col justify-between text-left">
          ...
          <Link to="/probabilityandstats/clt">
            <SubmitButton text="Open Calculator" />
          </Link>
        </div>
        ...
        <div className="bg-white rounded-md shadow-md p-6 border border-[#e0e0e0] flex flex-col justify-between text-left">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Explore statistical inference and hypothesis testing.
          </p>
          <Link to="/probabilityandstats/inference">
            <SubmitButton text="Open Calculator" />
          </Link>
        </div>
        ...
        <div className="bg-white rounded-md shadow-md p-6 border border-[#e0e0e0] flex flex-col justify-between text-left">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Explore linear regression and its applications.
          </p>
          <Link to="/probabilityandstats/regression">
            <SubmitButton text="Open Calculator" />
          </Link>
        </div>
      </div>
