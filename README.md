...
- **Frontend**: React + Vite + TailwindCSS + KaTeX
...
- Explain its use in **stochastic calculus**, risk modeling, etc.
...
Instructions on how to run the frontend + backend locally or deploy online.

---

## 🧪 Testing

Summary of test coverage and future testing strategy.

---

## 📌 Roadmap

What’s coming next? (AI strategy generation module, user profiles, history, etc.)

---

## 🧠 About the Author

Gabriel — CS undergrad, passionate about building the next generation of AI+Finance tools. On track to apply for top MSFE programs.
